...
public class UserDao {
    ...
    private static final String FIND_USERS_BY_GROUP_ID_QUERY = "SELECT * FROM users where group_id = ?";
    ...
    public List<User> findAllByGroupId(int groupId) {
        try (Connection conn = jdbcConnection.getConnection()) {
            List<User> users = new ArrayList<>();
            PreparedStatement statement = conn.prepareStatement(FIND_USERS_BY_GROUP_ID_QUERY);
